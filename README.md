...
<p align="center">
    ...
    <img src="https://img.shields.io/badge/Team%20Size-21-%230070A8"
         alt="Team size"></a>
...
- **Influencias**
  - **Libros**
    - [Maverick](https://www.amazon.com/Maverick-Success-Behind-Unusual-Workplace/dp/0446670553)
      ...
      - El autor escribe una crónica de una empresa familiar: una empresa manufacturera en el Brasil de los años 80, que creó una cultura sorprendente, eliminando la burocracia y la gestión innecesaria de los mandos medios. Esto fue, y sigue siendo, un logro revolucionario. Si entre los valores de tu startup están la confianza y la honestidad radical, este es tu libro.
    - [It Doesn&#39;t Have to be Crazy at Work](https://www.amazon.com/Doesnt-Have-Be-Crazy-Work-ebook/dp/B079WV79TK/ref=sr_1_1)
      - Autores: Jason Fried y David Heinemeier Hansson
      - Los chicos de Basecamp saben que el trabajo debería ser algo más que una actividad desgastante. Este libro es una guía para estar más tranquilo, ser más productivo y priorizar el bienestar de tu equipo mientras recuperas el control sobre tu tiempo.
    - [Traction](https://www.amazon.com/Traction-Get-Grip-Your-Business-ebook/dp/B007QWLLV2/ref=sr_1_3)
      - Autor: Gino Wickman
      - Un sistema operativo simple pero poderoso que le ayudará a tu equipo de liderazgo a tener un único enfoque y abordar de manera efectiva los problemas, los procesos, la ejecución, la administración y la comunicación. Nosotros desarrollamos nuestro propio sistema operativo basado en este libro.
  - **Personas**
    - Peldi de [Balsamiq](http://www.balsamiq.com/)
    - Ricardo Semler de [Semco](https://semcostyle.com/)
    - [Naval](https://twitter.com/naval) de AngelList
  - **Tuits**

      - Los beneficios de ser 100% Remoto y Asíncrono: <blockquote class="twitter-tweet"><p lang="en" dir="ltr">Going fully remote was nice, but the real benefit was in going fully asynchronous. Here are a list of the benefits we&#39;ve seen at <a href="https://twitter.com/gumroad?ref_src=twsrc%5Etfw">@Gumroad</a>:<br><br>A thread 👇🏽</p>&mdash; Sahil Lavingia (@shl) <a href="https://twitter.com/shl/status/1222545212477599751?ref_src=twsrc%5Etfw">January 29, 2020</a></blockquote> 
      - La buena comunicación en un equipo remoto: <blockquote class="twitter-tweet"><p lang="en" dir="ltr">Good communication in a remote team:<br>* Write status updates<br>* Communicate the obvious <br>* Format your writing effectively <br>* Confirm decisions to move them forward<br>* Offer conclusions in long discussions<br>* Make decisions transparent<br>* Take initiatives and deliver on your promises</p>&mdash; Alex 🌚 (@alexmuench) <a href="https://twitter.com/alexmuench/status/1207568727610404864?ref_src=twsrc%5Etfw">December 19, 2019</a></blockquote> 
      - Trabajando en remoto: <blockquote class="twitter-tweet"><p lang="en" dir="ltr">How to thrive as a <a href="https://twitter.com/hashtag/remote?src=hash&amp;ref_src=twsrc%5Etfw">#remote</a> worker<br><br>1/ Be nosy as hell.<br><br>Remote work can obscure the &quot;big picture&quot; view of your company, so read every public doc, spreadsheet, email and Slack thread. Leave unsolicited opinions in areas that interest you, or where you can add value.</p>&mdash; Ryan Law (@thinking_slow) <a href="https://twitter.com/thinking_slow/status/1220636328376905728?ref_src=twsrc%5Etfw">January 24, 2020</a></blockquote>  
- **Glosario**
  - **Chuletón Based**
    - Decimos que utilizamos tecnología basada en chuletón (&quot;chuletón-based technology&quot;), una broma interna sobre cómo la posibilidad de un festín alguna vez impulsó a nuestros desarrolladores a sobrepasar expectativas.
  - **Somos la p\*\*\*\* pero no tenemos ni p\*\*\* idea**
    - Es importante ser humilde pero también tener confianza total en nuestra capacidad como equipo y en el trabajo que hacemos.
  - **Watch Pennies**
    - No creemos en gastar &quot;solo porque podemos&quot;. Somos un equipo pequeño con recursos que elegimos invertir sensatamente.
  - **Expectante**
    - Durante cada reunión trimestral, cada uno de nosotros dice una palabra que describe cómo nos sentimos en ese momento. Muchos de nosotros hemos dicho &#39;expectante&#39; e incluso después de 6 años, al menos una persona siempre elige esa palabra.
  - **Are we there yet?**
    - Esta frase destaca lo lejos que hemos llegado y pero nos mantiene conscientes del viaje que aún nos queda.
  - **What Could Go Wrong?**
